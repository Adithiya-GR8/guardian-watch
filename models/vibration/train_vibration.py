...
from utils import load_and_engineer, compute_vib_features
...
N_ESTIMATORS = 150
CONTAMINATION = 0.10    # ~10% of training data contains fault behavior
RANDOM_STATE = 42
...
X_train = load_and_engineer(TRAIN_FILES, LOGS_DIR, TARGET_COL, compute_vib_features, WINDOW)
...
X_test = load_and_engineer(TEST_FILES, LOGS_DIR, TARGET_COL, compute_vib_features, WINDOW)
...
print("\n" + "=" * 60)
print("  Vibration model training complete.")
print("=" * 60)
